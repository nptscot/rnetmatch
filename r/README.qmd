...
```{r}
princes_street_minimal_x_1 = sf::st_difference(princes_street_minimal_x_1, princes_street_minimal_x_1_point_buffers)
```
...
sf::write_sf(princes_street_minimal, "data-raw/geojson/princes_street_minimal.geojson", delete_dsn = TRUE)
sf::write_sf(princes_street_minimal_x_1, "data-raw/geojson/princes_street_minimal_x_1.geojson", delete_dsn = TRUE)
```
